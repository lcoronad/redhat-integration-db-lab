    ...
    public void configure() throws Exception {
       ...
       .post(env.getProperty("service.rest.save.uri"))
           ...
           .param()
                ...
                .dataType("String")
                .example("{\"nombre\":\"Lazaro Miguel Coronado Torres\",\"cedula\": \"79541235\", \"salario\": \"5500000\"}")
                .description("JSON para consumir el servicio")
                .required(true)
           .endParam()
           .responseMessage()
               .code(200)
               .message("All users successfully created")
               .responseModel(ResponseSaveEmployees.class)
               .example("Ok", "{\"codigo\": \"200\", \"descripcion\": \"Ok\"}")
           .endResponseMessage()
           .responseMessage()
               .code(400)
               .message("Validation errors")
               .responseModel(ResponseSaveEmployees.class)
               .example("Error", "{\"codigo\": \"400\", \"descripcion\": \"El nombre no puede ser vacio\"}")
           .endResponseMessage()
